...
start "NVMatrixEngine CUDA Mixed Pressure Experiment" "%NVMATRIXENGINE_CUDA_LAB_DIR%\NVMatrixFluidLab.exe" --fluid-room --fluid-backend=cuda --fluid-cuda-graphs=on --fluid-cuda-pressure=mixed --quality=balanced --frame-gen=off
popd
